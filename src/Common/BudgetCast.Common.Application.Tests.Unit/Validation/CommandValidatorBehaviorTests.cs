...
{
    public class CommandValidatorBehaviorTests : ValidationBehaviorTestsBase
    {
        private ValidatorBehaviorFixture<ICommand<Result>, Result> _nonGenericResultBehavior;
        private ValidatorBehaviorFixture<ICommand<Result<FakeData>>, Result<FakeData>> _genericResultBehavior;
